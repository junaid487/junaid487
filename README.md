...
| **GenAI Focus** | ![LLM](https://img.shields.io/badge/LLMs-Prompt_Eng-orange) ![RAG](https://img.shields.io/badge/RAG-Vector_DBs-red) |
...
* 🏗️ **Model to System:** I don't just build models in notebooks; I build interfaces (Streamlit) to make AI functional.
* 🧹 **Clean Code:** Strong emphasis on modularity, documentation, and reproducibility.
* 📈 **Data Storytelling:** Translating complex model metrics into clear business value.
